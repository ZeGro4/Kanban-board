        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserExecutorId = table.Column<string>(type: "text", nullable: true),
                    Comments = table.Column<string>(type: "character varying(1500)", maxLength: 1500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoardTasks_AspNetUsers_UserCreatorId",
                        column: x => x.UserCreatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardTasks_AspNetUsers_UserExecutorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardTasks_UserCreatorId",
                table: "BoardTasks",
                column: "UserCreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardTasks_UserExecutorId",
                table: "BoardTasks",
